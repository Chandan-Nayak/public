...
1. **Focus on systems, not goals** - Goals are about the results you want, systems are about the processes that lead to those results
2. **The 1% improvement rule** - Small improvements compound into remarkable results over time
3. **The Four Laws of Behavior Change:**
   - Make it obvious (cue)
   - Make it attractive (craving)
   - Make it easy (response)
   - Make it satisfying (reward)
4. **Identity-based habits** - Focus on who you want to become, not what you want to achieve
5. **Environment design** - Make good habits obvious and bad habits invisible
6. **Habit stacking** - Link new habits to existing ones
